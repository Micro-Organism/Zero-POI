package com.zero.poi.common.util;
...
import com.zero.poi.service.impl.ExcelExportStylerServiceImpl;
...
public class FileUtil {
    ...
    public static void exportExcel(List<?> list, Class<?> pojoClass, String fileName, HttpServletResponse response) throws Exception {
        ...
        exportParams.setStyle(ExcelExportStylerServiceImpl.class); // set style
        defaultExport(list, pojoClass, fileName, response, exportParams);
    }
